...
const TOPICS: Record<Topic, { label: string; icon: string; prompt: string }> = {
  bug: {
    label: 'Баг', icon: '🐞',
    prompt: 'Опишите, что делали и что случилось: какое дело, какой экран, телефон или компьютер. Скриншот или видео очень помогут — присылайте следующими сообщениями.'
  },
  idea: {
    label: 'Идея', icon: '💡',
    prompt: 'Расскажите идею: новый мир, дело, механика или что-то в интерфейсе. Чем подробнее, тем лучше.'
  },
  review: {
    label: 'Отзыв о партии', icon: '💬',
    prompt: 'Какое дело, сколько вас было, раскрыли или нет, что понравилось и где застряли? Только без спойлеров — в это дело ещё будут играть другие.'
  }
}
