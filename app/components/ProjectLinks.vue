    ...
    <Teleport to="body">
      <div v-if="open" class="veil" @click.self="open = false">
        <div class="veil__card links" role="dialog" aria-modal="true">
          <h2 class="veil__title">Некоммерческий проект</h2>
          <p class="veil__text">Игра бесплатная. Новые дела выходят, пока их поддерживают: голоса, музыка и иллюстрации стоят денег. Наведите камеру телефона на код.</p>
